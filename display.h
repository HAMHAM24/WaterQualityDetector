/**
 * @file    display.h
 * @brief   Display Manager — mengelola inisialisasi hardware OLED SSD1306
 *          (I2C), pengaturan brightness/contrast, dan primitif tampilan
 *          umum (header, status bar) yang dipakai oleh seluruh halaman GUI.
